namespace XState
{
       ...
       where TResolvedTypesMeta : TypegenFlag // TypegenDisabled
    {
        ...
        {
            Config = config;
            Options = options ?? StateMachineUtility.CreateDefaultOptions<TContext, TEvent>();
            _context = context ?? config.Context ?? throw new ArgumentNullException("context was exoected");
            Parent = parent;
